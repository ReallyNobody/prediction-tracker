    ...
    def get_kalshi_markets(self):
        ...
        try:
            ...
            for market in markets:
                ...
                is_sports_parlay = (
                    ticker.startswith("KXMV")
                    or event_ticker.startswith("KXMV")
                    or self.has_sports_keywords(title)
                )
        ...
        if data["kalshi"]:
            ...
            for market in data["kalshi"][:10]:  # Show up to 10
                ...
                if market["yes_price"] is not None:
                    print(
                        f"  Yes Price: ${market['yes_price']:.2f} ({market['yes_price'] * 100:.0f}%)"
                    )
