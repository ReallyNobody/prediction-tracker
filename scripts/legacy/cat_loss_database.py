...
def demo():
    ...
    print(milton_losses[['company', 'ticker', 'net_loss_usd', 'gross_loss_usd', 'filing_date']].to_string(index=False))
    ...
    print(rnr_losses[['event_name', 'event_date', 'net_loss_usd', 'quarter']].to_string(index=False))
