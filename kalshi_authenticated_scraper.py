...
class KalshiAuthenticatedScraper:
    def __init__(self, api_key_id=None, private_key_path=None, demo=False):
        ...
        self.base_url = 'https://demo-api.kalshi.co/trade-api/v2' if demo else \
    ...
    def get_weather_markets(self):
        ...
        weather_series = [
            'KXHIGHLAX', 'KXHIGHNY', 'KXHIGHCHI', 'KXHIGHAUS', 'KXHIGHMIA',
            'KXHIGHTSFO', 'KXHIGHTSEA', 'KXHIGHTLV', 'KXHIGHPHIL', 
            'KXHIGHTNOLA', 'KXHIGHTDC', 'KXHIGHDEN', 'KXHIGHTBOS',
            'KXLOWTLAX', 'KXLOWTNYC', 'KXLOWTCHI', 'KXLOWTAUS', 'KXLOWTMIA',
            'KXLOWTPHIL', 'KXLOWTDEN',
            'KXNYCSNOWM', 'KXLAXSNOWM', 'KXRAINSFOM',
            'KXHMONTH',
        ]
